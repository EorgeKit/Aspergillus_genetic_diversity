...
#PBS -N making_nucleotide_blast_database_each_sample_contigs
...
echo
echo "Starting to make  NUCLEOTIDE BLAST databse for $sample_contig"
echo
makeblastdb \
...
echo "COMPLETED Making NUCLEOTIDE BLAST databse for $sample_contig"
echo "${myArray[@]}"
